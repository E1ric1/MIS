...
<body>
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            %>
            <div class="add"><a class="btn btn-success" href="addnewbuy.jsp">新增</a></div>
            <div class="w">
                <div class="span12">
                    <table class="table table-condensed table-bordered table-hover tab">
                        ...
                        <tbody id="tbody">
                         <tr>
                                     <%
	                                    ...
	                                    List<Order> list=order.foundOrder(id,orderclassid);
	                                    for(Order s: list){ 
                                      %> 
                                      <td><%=s.getOrder() %></td>
                                     <td><%=s.getOrderid() %></td>
                                     ...
                                     <td><%=s.getAcount() %></td>
                                     <td><%=s.getNote() %></td>
                                     <td><a href="DelOrder?orderid=<%=s.getOrderid()%>&&goodid=<%=s.getGoodid() %>" >删除</a></td>
                               </tr> 
                        ...
                        <tr>
                        	<td><a href="FindOutOrder?order=<%=id %>">提交</a></td>
                        </tr>
