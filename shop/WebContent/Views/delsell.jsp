...
<body>
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            %>
            <div class="add"><a class="btn btn-success" href="addnewsell.jsp">新增</a></div>
            <div class="w">
                <div class="span12">
                    <table class="table table-condensed table-bordered table-hover tab">
                        ...
                        <tbody id="tbody">
                         <tr>
                                     <%
	                                    ...
	                                    List<Order> list=order.foundOrder(oid,orderclassid);
	                                    for(Order s: list){ 
                                      %> 
                                      <td><%=s.getOrder() %></td>
                                     <td><%=s.getOrderid() %></td>
                                     ...
                                     <td><%=s.getAcount() %></td>
                                     <td><%=s.getNote() %></td>
                                     <td><a href="DelSellOrder?orderid=<%=s.getOrderid()  %>&&goodid=<%=s.getGoodid() %>"><input type="button" value="删除" /></a></td>
                               </tr> 
                        ...
                        <tr>
                        	<td><a href="outselltable.jsp?order=<%=oid%>"><input type="button" value="提交"></a></td>
                        </tr>
                    </table>
